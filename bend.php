...
$mail->AddAddress('enquiry@salemsit.org.in' , 'Salems I.T.');  // Add a recipient    */
            ...
            <tr>
              <td>
                <table align="center"  cellpadding="0" cellspacing="0"  width="360" style="padding-top:50px;padding-bottom:50px;"> 
                  ...
                  // </tr>       
                  <tr>
                    <td align="right" style="padding:10px 0px">Comments </td>
                    <td>&nbsp;&nbsp;&nbsp;</td>
                    <td align="">'.$Comments.'</td>
                  </tr>                     
                </table>
              </td>
            </tr>                
...
';
$subject = 'New Enquiry has been  Yippie';
